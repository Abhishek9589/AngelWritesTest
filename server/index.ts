...
import { handleSignIn, handleSignUp, handleVerifySignup, handleChangePassword, handleForgotInit, handleForgotVerify, handleForgotReset, handleSignOut, handleUpdateProfile } from "./routes/auth";
