...
import { Calendar as CalendarIcon, Search as SearchIcon, Eye, EyeOff } from "lucide-react";
      ...
      return (
        <div className="relative w-full">
          ...
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded-md text-foreground/70 hover:text-foreground hover:bg-foreground/5"
            tabIndex={0}
          >
