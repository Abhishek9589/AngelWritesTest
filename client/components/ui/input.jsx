...
const Input = React.forwardRef(({ className, type, name, defaultValue, value, onChange, ...props }, forwardedRef) => {
  ...
  if (type === "date") {
    ...
    const [text, setText] = React.useState(derivedText);
    React.useEffect(() => {
    ...
    const handleTextChange = (e) => {
      ...
      onChange == null ? void 0 : onChange({ ...e, target: { ...e.target, value: next } });
    };
  ...
  const isSearch = type === "search" || props["data-variant"] === "search";
